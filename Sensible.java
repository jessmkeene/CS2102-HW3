...
public interface Sensible {
     ...
     * Reads an ordered sequence of data from the weather sensors to store in the
     greenhouse
     * When called multiple times, appends the new readings after the current
     sensor readings
     * @param values An ordered sequence of [datetime, temperature, humidity,
    temperature, humidity, ..., datetime, temperature, humidity,....]
     * - a date and time in yyyymmddHHMMSS format. E.g.
    20231106183930 for Nov 11, 2023, 6:39:30pm
     * - temperature is either degrees Fahrenheit or -999 for an
    error case
    ...
    (you cannot assume that the date/time intervals will be regular)
     ...
     *
     * @return a new SensorReading object that has the middle temperature of all
     * the sensor values (value at index (size() / 2) of the sorted temperatures)
